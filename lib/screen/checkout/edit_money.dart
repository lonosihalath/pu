...
class ditMoney extends StatefulWidget {
  const ditMoney({Key? key}) : super(key: key);

  @override
  State<ditMoney> createState() => _ditMoneyState();
}

class _ditMoneyState extends State<ditMoney> {
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if(value ==1){
                    ...
                    if(value == 2){
                      paymentController.addmoney('BCEL One Pay');
                      Navigator.pop(context);
                    }
                  }
